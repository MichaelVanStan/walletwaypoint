...
- [ ] **INFRA-01**: All content pages are statically generated (SSG) or ISR for crawlability
...
- [ ] **INFRA-06**: Core Web Vitals passing on all pages (LCP < 2.5s, CLS < 0.1, INP < 200ms)
- [ ] **INFRA-07**: Responsive design that works on mobile, tablet, and desktop

### Legal & Trust

- [ ] **TRUST-01**: Standardized affiliate disclosure component displayed near all affiliate links
- [ ] **TRUST-02**: "Not financial advice" disclaimer on all calculator and guide pages
...
- [ ] **CALC-01**: Parameterized calculator engine that renders calculators from YAML/JSON config definitions
- [ ] **CALC-02**: Slider inputs with real-time result updates (no submit button)
- [ ] **CALC-03**: Precision math using decimal.js or integer-cents to avoid floating-point errors
...
- [ ] **CALC-06**: Calculator state stored in URL query params (nuqs) for bookmarkable/shareable results
- [ ] **CALC-07**: Side-by-side "what-if" scenario comparison (two sets of inputs, compared outcomes)
- [ ] **CALC-08**: Sensible default values for all calculator inputs based on national averages
...
| HUB-05 | TBD | Pending |
| HUB-06 | TBD | Pending |
| AFFIL-01 | TBD | Pending |
| AFFIL-02 | TBD | Pending |
| AFFIL-03 | TBD | Pending |
| AFFIL-04 | TBD | Pending |
| AFFIL-05 | TBD | Pending |
| AFFIL-06 | TBD | Pending |
