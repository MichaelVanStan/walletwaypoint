...
At 18.3%, our example is manageable but needs attention -- especially with $4,200 at 22.9% <Term>APR</Term>. The credit card is the fire that needs putting out first.
...
4. **Model your timeline.** Use our loan repayment calculator to see exactly when you will be debt-free based on your current payments and any extra you can add.
